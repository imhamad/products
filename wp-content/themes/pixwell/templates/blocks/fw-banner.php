		...
		<div class="el-banner rb-p15-gutter">
			<div class="el-banner-inner">
				...
				if ( ! empty( $settings['image'] ) ) :
					if ( ! empty( $lazyload ) ) : ?>
						<span class="s-lazyload rb-iwrap"><img class="rb-lazyload" src="data:image/gif;base64,R0lGODdhAQABAPAAAMPDwwAAACwAAAAAAQABAAACAkQBADs=" data-src="<?php echo esc_url( $settings['image'] ); ?>" alt="<?php echo esc_attr( $alt_text ); ?>"/></span>
					<?php else : ?>

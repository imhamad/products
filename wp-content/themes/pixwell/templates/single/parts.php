				...
				<div class="review-content">
					...
					<div class="review-footer">
						...
						if ( ! empty( $review_button ) ) : ?>
							<div class="review-action"><a class="review-btn" href="<?php echo esc_html($review_destination); ?>" target="_blank" rel="nofollow noreferrer"><?php echo esc_html($review_button); ?></a></div>
						<?php endif;

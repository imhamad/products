...
if ( ! function_exists( 'pixwell_editor_dynamic' ) ) {
	function pixwell_editor_dynamic() {
		...
		$body_font    = pixwell_get_option( 'font_body' );
		if ( ! class_exists( 'ReduxFramework' ) || empty( $body_font ) ) {
			return;
		}
		...
		if ( empty( $cache ) ) {
			...
			if ( ! empty( $heading_font['font-family'] ) ) {
				...
				$editor_css .= '.editor-styles-wrapper .wp-block h1,';
				$editor_css .= '.editor-styles-wrapper .wp-block h2,';
				$editor_css .= '.editor-styles-wrapper .wp-block h3,';
				$editor_css .= '.editor-styles-wrapper .wp-block h4,';
				$editor_css .= '.editor-styles-wrapper .wp-block h5,';
				$editor_css .= '.editor-styles-wrapper .wp-block h6,';
				$editor_css .= '.rtl .editor-styles-wrapper .wp-block h1,';
				$editor_css .= '.rtl.editor-styles-wrapper .wp-block h2,';
				$editor_css .= '.rtl .editor-styles-wrapper .wp-block h3,';
				$editor_css .= '.rtl .editor-styles-wrapper .wp-block h4,';
				$editor_css .= '.rtl .editor-styles-wrapper .wp-block h5,';
				$editor_css .= '.rtl .editor-styles-wrapper .wp-block h6,';
				...
				if ( ! empty( $heading_font['color'] ) ) {
					$editor_css .= 'color: ' . $heading_font['color'] . ';';
				}
				$editor_css .= '}';
			}
			...
			if ( ! empty( $global_color ) && '#ff8763' != strtolower( $global_color ) ) {
				...
				$editor_css .= '.editor-styles-wrapper a, a:active, a:hover';

		...
		return array(
			...
			'fields'     => array(
				...
				array(
					...
					'subtitle'       => esc_html__( 'These options will apply to for the post summary, excerpt and other small description on your site.', 'pixwell' ),
		...
		return array(
			...
			'fields'     => array(
				...
				array(
					...
					'units'          => 'px',
					'default'        => array(),
					'output'         => array( '.single-tagline h6' )
				),
				array(
		...
		return array(
			...
			'fields'     => array(
				...
				array(
					...
					'line-height'    => false,
					'units'          => 'px',
					'output'         => array( '.meta-info-author.meta-info-el' )
				),
				array(
